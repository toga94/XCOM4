	...
	public override void execute(int frameRate, float delay) {
		...
		if(fieldInfo != null) {
			if(hasCustomEase()) {
                ...
                if (valueType == (int)AMPropertyTrack.ValueType.String) CoroutineBehaviour.StartCoroutineDelay(component.gameObject, getWaitTime(frameRate, delay), (x) => { fieldInfo.SetValue(component, start_str); });
			} else {
                ...
                if(valueType == (int)AMPropertyTrack.ValueType.String) CoroutineBehaviour.StartCoroutineDelay(component.gameObject, getWaitTime(frameRate, delay), SetStringFunc );
            }
			...
			if(hasCustomEase()) {
                ...
                if (valueType == (int)AMPropertyTrack.ValueType.String) CoroutineBehaviour.StartCoroutineDelay(component.gameObject, getWaitTime(frameRate, delay), (x) => { propertyInfo.SetValue(component, start_str, null); });
            }
            else
            {
